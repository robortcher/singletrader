...
__bar_fields__ = ['$open', '$close', '$high', '$low', '$money', '$volume']
__bar_names__ = ['open', 'close', 'high', 'low', 'money', 'volume']
...
class BaseFactor(): 
    ...
    def setup_data(self, **kwargs):#instruments, start_date,end_date,freq):
        ...
        df = D.features(instruments, self._field, start_time=start_date, end_time=end_date, freq=freq)
