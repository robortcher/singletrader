...
from singletrader.datautils.dataapi.sqlapi import get_security_info,get_trade_days,ext_bardata_api2_pg,price_post_pg,auction_pg
...
APIS = {
    "bar_api":price_post_pg,
    "ext_bardata_api2":ext_bardata_api2_pg,
    "auction_api":auction_pg,
}
...
def DumpAll():
    ...
    DumpDataAll(api="ext_bardata_api2")()
    # DumpDataAll(api="auction_api")()

def Update(end_date=last_date_str):
    DumpDataUpdate(api="ext_bardata_api2",end_date=end_date)._dump_features()#聚宽备用股票拓展行情2
