...
import logging
import time
from singletrader.datautils.dataapi.config import ValuationConfigPG,PricePostConfigPG,AuctionConfigPG
...
price_post_pg = data_api_mode(db_config=PricePostConfigPG)
price_post_pg.all_factors = ['open', 'close', 'high', 'low', 'volume', 'money', 'avg', 'high_limit', 'low_limit', 'pre_close', 'paused', 'factor']

auction_pg = data_api_mode(db_config=AuctionConfigPG)
# auction_pg.all_factors = ['open', 'close', 'high', 'low', 'volume', 'money', 'avg', 'high_limit', 'low_limit', 'pre_close', 'paused', 'factor']

# def get_all_securities(**kwargs):
