...
if __name__ == '__main__':
    ...
    for i in range(len(train)):
        ...
        date_year = test[i][0]
        model.fit(dataset)
        save_pkl(model, f'D:/projects/singletrader_pro/samples/contribute/trademodel/models/{date_year}.pkl')
        pred = model.predict(dataset)
        save_pkl(pred, f'D:/projects/singletrader_pro/samples/contribute/trademodel/predict/{date_year}.pkl')
